...
public class EmpiricalTrial {
	...
	public String toString() {
		...
		printingExplaination(rootCauseFinder, buffer);
	...
	private void printingExplaination(RootCauseFinder rootCauseFinder2, StringBuffer buffer) {
		buffer.append("################################## \n");
		buffer.append("debug: Regression Explaination: \n");
		for(int i=1;i<rootCauseFinder.getRegressionNodeList().size();i++) {
		    buffer.append(rootCauseFinder.getRegressionNodeList().get(i).toString() + "\n");
		}
        buffer.append("################################## \n");
		buffer.append("debug: Correct Explaination: \n");
		for(TraceNode node: rootCauseFinder.getCorrectNodeList()) {
			buffer.append( node + "\n");
		}
		buffer.append("################################## \n");	
	}
