...
public class LoopHeadParser extends ASTVisitor{
	...
	public SourceScope extractScope(){
		//System.out.println("point class: " + this.point.getClassCanonicalName());
		String className = JavaUtil.getFullNameOfCompilationUnit(cu);
		if (className.equals("null")) {
			if (this.point.getDeclaringCompilationUnitName().equals("com.fasterxml.jackson.core.JsonToken")) 
				className = "JsonToken";
		}
