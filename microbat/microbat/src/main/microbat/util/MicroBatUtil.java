...
//		return new StringBuilder(IResourceUtils.getEclipseRootDir()).append(File.separator).append("trace").toString();
		return new StringBuilder("/Applications/Eclipse.app/Contents/Eclipse/").append(File.separator).append("trace").toString();//for mac users
