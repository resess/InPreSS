			...
			protected IStatus run(IProgressMonitor monitor) {
				try {
					String projectName = Activator.getDefault().getPreferenceStore()
							.getString(CorexPreference.PROJECT_NAME);
					String id = Activator.getDefault().getPreferenceStore().getString(CorexPreference.BUG_ID);
					String testcase = Activator.getDefault().getPreferenceStore()
							.getString(CorexPreference.TEST_CASE);
